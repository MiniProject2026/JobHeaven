...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-1">
      <div className="w-full max-w-md">
        ...
        <div className="border border-gray-400 rounded-2xl p-8 shadow-lg backdrop-blur-sm">
          <form onSubmit={submitHandler} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="jobseeker">Find your job</option>
            ...
            {role && (
              <div className="space-y-5 aimate-in fade-in duration-300">
                <div className="space-y-2">
                ...
                {role === "jobseeker" && (
                  <div className="space-y-5 pt-4 border-1">
                    <div className="space-y-2">
